  ...
  return (
    <div className="min-h-screen relative bg-gradient-to-b from-slate-900 via-slate-800 to-amber-900/30 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row-reverse justify-center lg:justify-between items-center p-4 lg:p-6 min-h-screen gap-8 lg:gap-0 px-4 lg:px-30">
        ...
        >
          ...
          <motion.button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-amber-600/20 text-gray-200 font-semibold rounded-md border border-amber-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 transition-all duration-300 shadow-lg mb-4 text-sm sm:text-base"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      {registerError && (
        ...
        >
          <motion.div 
            className="flex flex-col relative justify-around items-center w-[90%] sm:w-[450px] bg-slate-900/95 border-2 border-amber-500/30 rounded-lg p-8 shadow-2xl shadow-amber-500/20"
          ...
          >
            ...
            {/* Title */}
            <motion.div
              className="text-xl sm:text-2xl text-center press-start-2p-bold bg-gradient-to-r from-amber-400 to-orange-500 bg-clip-text text-transparent mb-4"
              animate={{
                textShadow: [
                  "0 0 10px rgba(245, 158, 11, 0.5)",
                  "0 0 20px rgba(245, 158, 11, 0.8)",
            ...
            {/* Button */}
            <motion.button
              className="w-full sm:w-2/3 px-6 py-3 bg-gradient-to-r from-amber-600 to-orange-600 text-white medievalsharp-regular rounded-md relative overflow-hidden shadow-lg hover:shadow-amber-500/40"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
